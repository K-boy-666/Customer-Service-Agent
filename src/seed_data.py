...
def _build_shipment_events(
    ...
    def loc(i):
        return TRACKING_LOCATIONS[(location_idx + i) % len(TRACKING_LOCATIONS)]
        ...
        events.append(
            {
                ...
                "location": loc(2),
                "description": TRACKING_DESCRIPTIONS["out_for_delivery"].format(courier="李师傅", phone="13900001111"),
                "event_time": ts.isoformat(),
            }
        )
